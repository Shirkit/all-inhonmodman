 ...
 * @version %I%, %G%
 */
public class MathSup extends MathElement
{

  /** The XML element from this class */
  public final static String ELEMENT = "msup";
...
public void setFontSize(final int fontsize)
  {
    ...
    public void paint(final Graphics g, final int posX, final int posY)
    {
        ...
        //                 posY - (e2.getDescentHeight(true) + getMiddleShift()));
                        posY - Math.max(e2.getDescentHeight(true) + getMiddleShift(),
    ...
    public int getAscentHeight(final boolean dynamicParts)
    {
        ...
        return Math.max(
                    Math.max(getMathElement(0).getAscentHeight(true),
                                        getMathElement(1).getHeight(true) + getMiddleShift()),
                    getMathElement(0).getAscentHeight(true) + getMathElement(1).getAscentHeight(true)
                        );
    }
