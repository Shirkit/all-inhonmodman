...
public void setFontSize(final int fontsize)
    ...
    public void paint(final Graphics g, final int posX, final int posY)
    {
        ...
        if (accent)
            e2.paint(g, posX + (width - e2.getWidth(true)) / 2,
                         posY - (e1.getAscentHeight(true) + 1));
        else
            e2.paint(g, posX + (width - e2.getWidth(true)) / 2,
   ...
   */
    ...
    {
        if (accent)
            return getMathElement(0).getHeight(true) + getMathElement(1).getAscentHeight(true) + 1;
        else
            return getMathElement(0).getHeight(true) + getMathElement(1).getHeight(true);
    }
   ...
   */
    ...
    {
        if (accent)
            return getMathElement(0).getAscentHeight(true) + getMathElement(1).getAscentHeight(true) + 1;
        else
